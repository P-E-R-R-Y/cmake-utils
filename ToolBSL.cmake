...
function(bsl_store)
    if (DEFINED BUILD_SHARED_LIBS)
        ...
        message(STATUS "[bsl_store] stored 'BUILD_SHARED_LIBS' ${BUILD_SHARED_LIBS} locally and unset it.")
    else()
...
function(bsl_restore)
    if (DEFINED BSL_LOCAL)
        ...
        message("[bsl_restore] restore BUILD_SHARED_LIBS ${BUILD_SHARED_LIBS} from a local value.")
    else()
